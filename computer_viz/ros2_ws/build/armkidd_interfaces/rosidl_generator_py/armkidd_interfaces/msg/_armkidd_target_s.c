...
bool armkidd_interfaces__msg__armkidd_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("armkidd_interfaces.msg._armkidd_target.ArmkiddTarget", full_classname_dest, 52) == 0);
  }
  armkidd_interfaces__msg__ArmkiddTarget * ros_message = _ros_message;
  {  // target_x
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * armkidd_interfaces__msg__armkidd_target__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ArmkiddTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("armkidd_interfaces.msg._armkidd_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmkiddTarget");
  ...
  armkidd_interfaces__msg__ArmkiddTarget * ros_message = (armkidd_interfaces__msg__ArmkiddTarget *)raw_ros_message;
  {  // target_x
    PyObject * field = NULL;
