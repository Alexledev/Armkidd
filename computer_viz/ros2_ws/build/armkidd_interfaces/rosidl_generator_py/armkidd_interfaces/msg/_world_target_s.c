...
bool armkidd_interfaces__msg__world_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("armkidd_interfaces.msg._world_target.WorldTarget", full_classname_dest, 48) == 0);
  }
  armkidd_interfaces__msg__WorldTarget * ros_message = _ros_message;
  {  // target_x
...
{
  /* NOTE(esteve): Call constructor of WorldTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("armkidd_interfaces.msg._world_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WorldTarget");
