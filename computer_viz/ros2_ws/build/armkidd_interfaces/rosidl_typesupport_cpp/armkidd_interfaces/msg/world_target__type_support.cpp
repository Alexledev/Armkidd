...
static const _WorldTarget_type_support_symbol_names_t _WorldTarget_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, armkidd_interfaces, msg, WorldTarget)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, armkidd_interfaces, msg, WorldTarget)),
  }
};
...
{
  return &::armkidd_interfaces::msg::rosidl_typesupport_cpp::WorldTarget_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, armkidd_interfaces, msg, WorldTarget)() {
  return get_message_type_support_handle<armkidd_interfaces::msg::WorldTarget>();
}
